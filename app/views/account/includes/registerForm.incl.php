<form action="<?=PROOT?>register/register" method="POST">
    ...
    <div class="form-group">
        ...
        <input type="text" value='<?=$userData["username"] ?? ""?>' required class="form-control" name="username"
            id="username">
    </div>

    <div class="form-group">
        <label for="email">Email address</label>
        <input type="email" value='<?=$userData["email"] ?? ""?>' required class="form-control" name="email" id="email"
    ...
    <div class="form-group">
        ...
        <input type="text" value='<?=$userData["street"] ?? ""?>' required class="form-control" name="street"
            id="street">
    </div>
